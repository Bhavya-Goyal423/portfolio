      ...
      <div className="container">
        <div className="theme">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={`w-6 h-6 theme-icon ${theme === "day" ? "" : "hide"}`}
          >
            <path
              strokeLinecap="round"
          ...
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={`w-6 h-6 theme-icon ${theme === "night" ? "" : "hide"}`}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <div className="details">
          <div className="my-details">
            ...
            <p className="name">Bhavya Goyal</p>
            <p className="role">Web Developer</p>
          </div>
          <div className="contact-social">
            {/* !------------Instagram----------------  */}
            <a
              href="https://www.instagram.com/bhavyagoel1422/"
              target="_blank"
          ...
          <div className="cv contact-me">
            <a className="resume-btn" href="/cv/resume.pdf" download>
              Download CV{" "}
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-6 h-6 download-icon"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <a href="mailto:goel2000bhavya@gmail.com">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="32"
                height="32"
        ...
        <div className="showcase">
          <div className="cta">
            <div
              className={`projects ${showcase === "projects" ? "active" : ""}`}
              onClick={() => setShowcase("projects")}
            >
              Projects
            </div>
            <div
              className={`skills ${showcase === "skills" ? "active" : ""}`}
              onClick={() => {
                setShowcase("skills");
              }}
            >
          ...
          {showcase === "skills" && (
            <div className="skills-section">
              ...
              <div className="backend">
                <p className="heading">Backend Developer</p>
                <div className="skills-showcase">
                  <div className="skill">
                    <p>
                      Node JS
